      ...
      <div className="p-4 sm:ml-64">
        <Link to="/jadwal">
          <button className="mt-14 flex gap-2 items-center">
            ...
            <h1 className="text-2xl font-bold capitalize">edit jadwal</h1>
          </button>
        </Link>
              ...
              <form>
                <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                  ...
                  <div>
                    ...
                    <select className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 capitalize">
