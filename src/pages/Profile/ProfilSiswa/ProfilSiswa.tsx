  ...
  return (
    <div>
      ...
      <div className="p-4 sm:ml-64">
        <div className="mt-14">
          <div
            className="flex items-center p-4 mb-4 text-sm text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800"
            role="alert"
          >
            <svg
              ...
              <>
                <div className="relative z-20 flex gap-6 animate-pulse">
                  <div className="relative -top-12 lg:-top-14 z-30 left-5 md:left-8 lg:left-10">
                    ...
                    <div className="mt-3 h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 mb-4" />
                  </div>
                  ...
                  <div className="flex gap-6">
                    <div className="relative -top-12 lg:-top-14 z-20 left-5 md:left-8 lg:left-10">
                      <img
                        ...
                        alt="user image"
                      />
                      <h5 className="text-sm md:text-base lg:text-lg text-center text-gray-500 dark:text-gray-400 uppercase mt-2">
