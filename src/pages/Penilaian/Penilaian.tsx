	...
	return (
		<div>
			...
			<div className="p-4 sm:ml-64">
				<div className=" mt-14">
					<h1 className="text-3xl font-bold font-mono">Penilaian</h1>
				</div>
				<div className="mt-4">
					<div className="bg-[#F5EBB6] p-3 rounded-2xl border-2 flex gap-2 items-center">
						<svg
				...
				<div>
					<div className="mt-4 flex items-center bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full px-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
						<label
							htmlFor="countries"
