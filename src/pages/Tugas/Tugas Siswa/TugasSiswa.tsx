...
const TugasSiswa = ({ id }: { id: (string | undefined)[] }) => {
  ...
  //         const response = await axios.get('http://192.168.66.239:13311/api/Assignments/{id}');
  ...
  const handleUpdateAssignmentSubmissions = async (formData, assignmentId) => {
    try {
      ...
      const response = await fetch(
        `http://192.168.66.239:13311/api/AssignmentSubmissions/student/${studentId}/assignment/${assignmentId}`,
        {
          method: "PUT",
          headers: {
