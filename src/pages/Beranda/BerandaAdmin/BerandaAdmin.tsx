        ...
        <div className="mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-4 mt-6">
            ...
            <div className="bg-white rounded-md">
              <h1
                className="p-3 text-xl font-sans capitalize font-semibold
              "
              >
                daftar siswa alfa
              </h1>
              <Table>
                <Table.Head>
                  <Table.HeadCell className="capitalize">nama</Table.HeadCell>
                  <Table.HeadCell className="capitalize">kelas</Table.HeadCell>
                </Table.Head>
                <Table.Body className="divide-y">
                  <Table.Row className="bg-white">
                    <Table.Cell className="font-medium text-gray-700 capitalize">
                      putri
                    </Table.Cell>
                    <Table.Cell className="font-medium text-gray-700 uppercase">
                      rpl
                    </Table.Cell>
                  </Table.Row>
                </Table.Body>
